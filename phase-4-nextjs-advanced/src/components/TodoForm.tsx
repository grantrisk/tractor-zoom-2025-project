...
export const TodoForm = ({ onAddTask }: TodoFormParam) => {
    // AI-generated: `onAddTask` is a prop (function) passed from the parent `TodoList` component, demonstrating data flow from parent to child.
